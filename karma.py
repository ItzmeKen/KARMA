...
boot_anim = [f"{Style.BRIGHT}{Fore.LIGHTWHITE_EX}Booting {Fore.RED}KARMA {Fore.RESET}{Fore.LIGHTWHITE_EX}Bot",
             f"{Fore.RED}25%",
             f"{Fore.YELLOW}50%",
             f"{Fore.LIGHTYELLOW_EX}75%",
             f"{Fore.LIGHTGREEN_EX}99%",
             f"{Fore.LIGHTBLUE_EX}KARMA Bot booted"]
if not boot:
...
async def massdm():
        ...
        input(f"\n{Fore.WHITE}Thanks for using {Fore.YELLOW}KARMA\nPress Enter to return to the main menu")
        return await main()
...
async def exit():
        await client.close()
        input(f"{Fore.WHITE}Thanks for using {Fore.YELLOW}KARMA\nPress Enter 5 times to close the program.")
...
'''))
    print(f'''
{Fore.LIGHTWHITE_EX}                                   Made by {Fore.YELLOW}ItzmeKen 
{Fore.LIGHTWHITE_EX}Check out the github page for updates: {Fore.LIGHTBLUE_EX}https://github.com/ItzmeKen/Karma/           
